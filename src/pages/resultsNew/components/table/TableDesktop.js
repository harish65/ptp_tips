      ...
      {!props.allABND ? (
        <>
          <Table
            ...
            hover
            size="sm"
            responsive={window.innerWidth < 1350 ? true : false}
              ...
              <tr>
                ...
                <th style={{ width: "30%" }}>
                  <div style={{ display: "flex" }}>
                    <span style={{ marginRight: 20 }}>Selections</span>
                    <div
                      style={{
                        display: "flex",
                        justifyContent: "center",
          ...
          >
                  ...
                  <Row style={{ margin: 0, padding: 0 }}>
                    ...
                    <Col xs={6} style={{ marginLeft: 0, paddingLeft: 0 }}>
                      ...
                      >
                        (
                        {props.selections
                          ? ((props.second / props.selections) * 100).toFixed(
                              1
                            ) + "%"
                          : "0.00%"}
                        )
                  ...
                  <Row style={{ margin: 0, padding: 0 }}>
                    ...
                    <Col xs={6} style={{ marginLeft: 0, paddingLeft: 0 }}>
                      ...
                      >
                        (
                        {props.selections
                          ? ((props.third / props.selections) * 100).toFixed(
                              1
                            ) + "%"
                          : "0.00%"}
                        )
                  ...
                  <Row style={{ margin: 0, padding: 0 }}>
                    ...
                    <Col xs={6} style={{ marginLeft: 0, paddingLeft: 0 }}>
                      ...
                      >
                        (
                        {props.selections
                          ? ((props.lost / props.selections) * 100).toFixed(1) +
                            "%"
                          : "0.00%"}
                        )
                      </div>
            ...
            <Col lg={2} md={2} xs={12} style={{ marginTop: 10 }}>
              <h4>All Time</h4>
            </Col>
            <Col lg={10} md={10} xs={12} style={{ marginTop: 10 }}>
              <Row>
                <Col lg={3} md={3} xs={6}>
...
export default connect(mapStateToProps, mapDispatchToProps)(TableDesktop);
