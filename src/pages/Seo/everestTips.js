...
class EverestTips extends React.Component {
  constructor() {
    super();
    this.state = {
      isOpen: false,
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>The Everest Free Tips | PTP Tips</title>
          ...
          <meta
            name="description"
            content="The Everest Free Tips , find out Melbourne Cup's free horse racing tips in Australia with PTP Tips now !"
          />
          <link
            rel="canonical"
            href="https://www.ptptips.com.au/everest-free-tips"
          />
        </Helmet>
        ...
        <div style={{ marginTop: 30, marginBottom: 30 }}>
          ...
          >
            <Col xs={12} style={{ marginTop: 20 }}>
              <h1 style={{ textAlign: "center" }}>The Everest Free Tips</h1>
              <p style={{ textAlign: "justify" }}>
                The Everest is the richest race in the world and has a prize
                purse of $15 million (AUD) to be contended for. The Everest is
                held at Randwick Racecourse in Sydney, Australia. The Everest
                free tips, The Everest free ratings, The Everest free form
                guide, The Everest free predictions. The Everest free tips are
                uploaded to the website 2 days before The Everest day. The
                Everest free ratings are analyzed and uploaded to the website 2
                days before The Everest day. The Everest free form guide
                available 2 days before The Everest day. The Everest free
                predictions are uploaded to the website 2 days before The
                Everest day. The Everest free horse racing tips are also
                analyzed and uploaded for the final time by no later than 11am
                on The Everest day.
              </p>
...
export default withRouter(connect(mapStateToProps)(EverestTips));
