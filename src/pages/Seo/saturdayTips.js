...
class SaturdayTips extends React.Component {
  constructor() {
    super();
    this.state = {
      isOpen: false,
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>Saturday Horse Racing Tips | PTP Tips</title>
          <meta name="author" content="PTP TIPS"></meta>
          <meta http-equiv="X-UA-Compatible" content="IE=edge" />
          <meta
            name="keywords"
            content="Horse racing tips ,PTP TIPS, Past The Post, free horse racing tips , free trial , Sign up , australia, bets, odds, winner, monney, ratings "
          ></meta>
          <meta
            name="description"
            content="Saturday Horse Racing Tips , find out Saturday's free horse racing tips in Australia with PTP Tips now !"
          />
          <link
            rel="canonical"
            href="https://www.ptptips.com.au/saturday-horse-racing-tips"
          />
        </Helmet>
          ...
          >
            <Col xs={12} style={{ marginTop: 20 }}>
              ...
              <p style={{ textAlign: "justify" }}>
                Saturday races are the biggest day of the week for horse racing
                and past the post tips has a free tip for Saturday horse racing
                in every race. Saturday’s free horse racing tips are available
                along with Saturday form guide, Saturday free horse racing
                predictions and Saturday’s horse racing card every Wednesday
                night or Thursday morning. Free horse racing tips for Saturday
                are uploaded to the website 2 days before Saturdays races.
                Saturday free horse racing tips are also analyzed and uploaded
                for the final time by no later than 11am every Saturday.
              </p>
...
export default withRouter(connect(mapStateToProps)(SaturdayTips));
