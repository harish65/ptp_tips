...
class TomorrowTips extends React.Component {
  constructor() {
    super();
    this.state = {
      isOpen: false,
  ...
  render() {
    return (
      <div>
        <Helmet>
          <title>Tomorrow's Horse Racing Betting Tips | PTP Tips</title>
          ...
          <meta
            name="description"
            content="Tomorrow’s Horse Racing Betting Tips , find out Tomorrow's free tips in Australia with PTP Tips now !"
          />
          <link
            rel="canonical"
          ...
          >
            <Col xs={12} style={{ marginTop: 20 }}>
              ...
              <p style={{ textAlign: "justify" }}>
                If you are looking to get a head start on your bets for
                tomorrow’s horse racing, then you can find our horse betting
                tips 2-3 days before the race starts. We always analyze and
                upload our horse racing tips between 2-3 days in advance. Our
                free horse racing tips for tomorrow gives punters ample time to
                decide what horse racing tips they would like to bet on. Please
                note that we re-analyze our horse racing tips for tomorrow on
                the morning of each race day to factor in any last-minute
                changes such as jockey, barrier, weight etc. All final free tips
                and ratings are analyzed and uploaded to the website by no later
                than 11am on that race day.
              </p>
...
export default withRouter(connect(mapStateToProps)(TomorrowTips));
